...
Professionals.controller('HeaderController', ['$scope', '$routeParams', '$http', '$rootScope', '$location', '$modal', 'CommonService','HeaderOptions','Helper',
    function HeaderController($scope, $routeParams, $http, $rootScope, $location, $modal, CommonService, HeaderOptions,Helper) {
