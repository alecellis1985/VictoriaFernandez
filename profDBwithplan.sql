...
INSERT INTO `plan` VALUES (2, 'Profesional', 'Premium', 900);
INSERT INTO `plan` VALUES (3, 'Empresarial', 'Basico', 800);
INSERT INTO `plan` VALUES (4, 'Empresarial', 'Premium', 1200);
...
INSERT INTO `users` VALUES (16, 'Juan', 'Gonzales', 'elgonchi@gmail.com', '262321651', '09861651', 'tucuman 2121', '6251651651', 2, 1, NULL, 'wawa.com.uy', 'logoJPG.jpg', 'https://www.facebook.com/alec.ellis.714', 'https://www.twitter.com', 'https://www.linkedin.com/profile/view?id=172168721&trk=nav_responsive_tab_profile', 'afsaf', 'asfa', 'fasfas', 'asfaf', 'fasf', 'fasf', 'fasf', 'fasf', 'El_Gonchi', 'ahfahf', 0);
INSERT INTO `users` VALUES (17, 'Terry', 'Fierry', 'el_garca@gmail.com', '262321651', '09861651', 'tucuman 2121', '6251651651', 2, 1, NULL, 'wawa.com.uy', 'logoJPG.jpg', '', 'https://www.twitter.com', 'https://www.linkedin.com/profile/view?id=172168721&trk=nav_responsive_tab_profile', 'afsaf', 'asfa', 'fasfas', 'asfaf', 'fasf', 'fasf', 'fasf', 'fasf', 'El_Tierri', 'zukulu', 0);
INSERT INTO `users` VALUES (18, 'BinAD', 'Ladennw', 'alecellis1985@gmail.com', '26013794', '098635923', 'Maximo tajen 3565', '26013794', 2, 1, NULL, '', '', '', '', '', 'qcpdEXwvoSTaqqSxKkBFQPSxrjJcLhpUgOoZFRKuOsOIpXzzuw', 'vxlvwXZOKZKLrUlcuusu', 'NXJPWGYJzUNZDACXkgDo', 'trSfWKgWkXIYJtLElBsA', 'LSyjbXeRmkYDwaCVIAsq', 'djYguRtulZwpstZDYzow', 'zMYvRrVKXzKAPWGrsxAJ', 'fasf', 'BspcijE', 'a8f5f167f44f4964e6c998dee827110c', 0);
...
INSERT INTO `users` VALUES (20, 'BinWY', 'LadenMk', 'alecellis1985@gmail.com', '26013794', '098635923', 'Maximo tajen 3565', '26013794', 3, 2, NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', 'ehNDzsb', 'a8f5f167f44f4964e6c998dee827110c', 0);
INSERT INTO `users` VALUES (21, 'BinQa', 'LadenQw', 'alecellis1985@gmail.com', '26013794', '098635923', 'Maximo tajen 3565', '26013794', 2, 2, NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', 'JmddKRN', 'a8f5f167f44f4964e6c998dee827110c', 0);
INSERT INTO `users` VALUES (22, 'BinPL', 'LadenzG', 'alecellis1985@gmail.com', '26013794', '098635923', 'Maximo tajen 3565', '26013794', 2, 2, NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', 'aIlkhYo', 'a8f5f167f44f4964e6c998dee827110c', 0);
INSERT INTO `users` VALUES (23, 'BinWH', 'LadendD', 'alecellis1985@gmail.com', '26013794', '098635923', 'Maximo tajen 3565', '26013794', 2, 2, NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', 'AypaNRD', 'a8f5f167f44f4964e6c998dee827110c', 0);
INSERT INTO `users` VALUES (24, 'Bincw', 'LadentX', 'alecellis1985@gmail.com', '26013794', '098635923', 'Maximo tajen 3565', '26013794', 2, 2, NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', 'sdPSmOi', 'a8f5f167f44f4964e6c998dee827110c', 0);
INSERT INTO `users` VALUES (25, 'Bingd', 'LadenPf', 'alecellis1985@gmail.com', '26013794', '098635923', 'Maximo tajen 3565', '26013794', 2, 2, NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', 'yAvwMxn', 'a8f5f167f44f4964e6c998dee827110c', 0);
...
-- 
-- Constraints for table `diasatencion`
-- 
ALTER TABLE `diasatencion`
  ADD CONSTRAINT `diasatencion_users` FOREIGN KEY (`idUser`) REFERENCES `users` (`idUser`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- 
-- Constraints for table `formasdepago`
-- 
ALTER TABLE `formasdepago`
  ADD CONSTRAINT `formasdepago_users` FOREIGN KEY (`idUser`) REFERENCES `users` (`idUser`);

-- 
-- Constraints for table `users`
-- 
ALTER TABLE `users`
  ADD CONSTRAINT `users_barrios` FOREIGN KEY (`barrio`) REFERENCES `barrios` (`barrioId`) ON UPDATE CASCADE,
  ADD CONSTRAINT `users_categoria` FOREIGN KEY (`categoria`) REFERENCES `categorias` (`categoriaId`) ON UPDATE CASCADE,
  ADD CONSTRAINT `users_departamento` FOREIGN KEY (`departamento`) REFERENCES `departamentos` (`idDepartamento`) ON UPDATE CASCADE;
